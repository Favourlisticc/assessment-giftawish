...
import Partherosect from './components/partherosec';

function App() {
  const [words] = useState([
  'Sharing<span class="text-[#DD6421]"> Love </span>  through the Art of <span class="text-[#DD6421]">Gifting</span>',
  'Discover the Joy of <span class="text-[#DD6421]">Gifting</span> Made Easy From Somebody to Anybody '
  ]);
  ...
  return (
    <div className="">
      ...
      <div className='ml-16 flex mb-6 max-sm:flex-col max-sm:ml-0'>
          ...
          <h1 className='font-bold text-5xl' dangerouslySetInnerHTML={{ __html: part }}/>
              ...
              <button type="button" class=" mt-7 drop-shadow-md hover:drop-shadow-2xl focus:outline-none text-white bg-[#DD6421] hover:bg-[#DD6421]/80 focus:ring-2 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-900">BROWSE GIFTS</button>
          </div>
           ...
           <div className='flex shadow-xl rounded-2xl w-96 max-sm:w-full p-2 mb-10 max-sm:mb-5 '>
              ...
              <img src={wresltinh} alt='' className='w-9'/>
               ...
               <p className='font-bold text-[#DD6421]'>1. Browse Gifts</p>
                <p className='font-semibold'>Find the perfect gift from our curated selection</p>
               </div>
            </div>
            ...
            <div className='flex shadow-xl rounded-2xl w-96 max-sm:w-full p-2 mb-10 max-sm:mb-5'>
              ...
              <img src={gift} alt=''className='w-9'/>
                ...
                <p className='font-semibold'>Make wishes for items that you desire</p>
                </div>
            </div>
          ...
          <div  className='flex shadow-xl rounded-2xl w-96 p-2 max-sm:w-full mb-10 max-sm:mb-5'>
             ...
             <img src={addfriend} alt='' className='w-9'/>
                ...
                <div className='pt-5 pl-3'>
                  ...
                  <p className='font-semibold'>Add a heartfelt message to your gift</p>
                </div>
            </div>
           </div>
            ...
            <div  className='flex shadow-xl rounded-2xl w-96 p-2 mb-10 max-sm:mb-5 max-sm:w-full'>
              ...
              <img src={message} alt='' className='w-32'/>
               ...
               <div className='pt-5 pl-3'>
               <p className='font-bold text-[#DD6421]'>4. Personalise message</p>
            ...
            <div  className='flex shadow-xl rounded-2xl w-96 p-2 mb-10 max-sm:mb-0 max-sm:w-full'>
             ...
             <img src={shopping} alt='' className='w-9'/>
               ...
               <div className='pt-5 pl-3'>
                  ...
                  <p className='font-semibold'>Complete your purchase in minutes</p>
               </div>
            </div>
            </div>
        </div>
        ...
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-5 sm:gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="/" class="hover:border-b-4 pb-1 border-b-[#DD6421]">Our Story</a>
                        </li>
                        <li class="mb-4">
                            <a href="/" class="hover:border-b-4 pb-1 border-b-[#DD6421]">Community</a>
                        </li>
                        <li class="mb-4">
                            <a href="/" class="hover:border-b-4 pb-1 border-b-[#DD6421]">Terms & condition</a>
                        </li>
            ...
            <div className=''>
                ...
                <div className='flex mt-20 max-sm:mt-3' >
                  <button type="button" class="text-white drop-shadow-md hover:drop-shadow-xl bg-[#DD6421] hover:bg-[#DD6421]/80 focus:ring-4 focus:outline-none focus:ring-[#DD6421]/50 font-medium rounded-lg text-sm px-2 py-2.5 text-center flex items-center dark:hover:bg-[#DD6421]/80 dark:focus:ring-[#DD6421]/40 me-2 mb-2">
                    <div>
                ...
                <button type="button" class="text-white drop-shadow-md hover:drop-shadow-xl bg-[#DD6421] hover:bg-[#DD6421]/80 focus:ring-4 focus:outline-none focus:ring-[#DD6421]/50 font-medium rounded-lg text-sm px-2 py-2.5 text-center inline-flex items-center dark:hover:bg-[#DD6421]/80 dark:focus:ring-[#DD6421]/40 me-2 mb-2">
                 <div>
            ...
            <div >
                ...
                <a href="#" class="text-[#DD6421] hover:text-gray-900 dark:hover:text-white drop-shadow-md hover:drop-shadow-xl">
